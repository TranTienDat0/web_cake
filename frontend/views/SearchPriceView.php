            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    ...
                    <h2 class="title text-center">
                        Sản phẩm có giá <?php echo $fromPrice; ?>đ - đến <?php echo $toPrice; ?>đ
                    </h2>
                    ...
                    <div>
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link"
                                    href="index.php?controller=search&action=price&fromPrice=<?php echo $fromPrice; ?>&toPrice=<?php echo $toPrice; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a>
                            </li>
                            <?php endfor; ?>
                        </ul>
                    </div>
