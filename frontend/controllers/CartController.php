	...
	class CartController extends Controller{
		...
		public function checkout(){
			...
			if(isset($_SESSION['customer_email']) == false)
				...
				// $this->cartCheckOut();
				header("location:index.php?controller=cart&action=Viewcheckout");
			}
		}
		//checkout
        ...
        public function checkoutcustomer(){
        	$this->modelcheckoutcustomer();
        	header("location:index.php?controller=cart&action=payment");
        }
        public function orderplace(){
        	
            	$this->cartCheckOut();
            	header("location:index.php?controller=cart&action=hashcart");
            
        }
        public function hashcart(){
        	$this->loadView('HashCart.php');
        }
	}
 ?>